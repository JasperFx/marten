...
<<< @/../src/Marten.Testing/Examples/MultiTenancy.cs#sample_tenancy-scoping-session-write

As with storing, the load operations respect tenancy of the session.

<<< @/../src/Marten.Testing/Examples/MultiTenancy.cs#sample_tenancy-scoping-session-read
...
<<< @/../src/Marten.Testing/Acceptance/multi_tenancy.cs#sample_tenancy-mixed-tenancy-non-tenancy-sample
