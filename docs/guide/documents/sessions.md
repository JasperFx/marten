...
If for some reason you need to completely remove a document from a session's [identity map](/guide/documents/identity) and [unit of work tracking](/guide/documents/sessions), as of Marten 2.4.0 you can use the
