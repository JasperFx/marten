...
* *Projection* -- a projected view defined by the `IProjection` interface and registered with Marten. See also [Projections](/guide/events/projections/).
...
If you're using [Marten's command line support](/guide/configuration/cli), you have the new `projections` command to help
