...
* **Aggregates across Streams** -- creating a rolled up view of a user-defined grouping of events across streams. These projections are done by subclassing the `ViewProjection<TDoc, TId>` class and is further described in [View Projections](/guide/events/projections/view-projections).
...
To create aggregate projections that include events in multiple streams, see [View Projections](/guide/events/projections/view-projections).
