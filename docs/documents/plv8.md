...
<!-- snippet: sample_plv8_set_an_immediate_property_by_where_clause -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L134-L137' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_set_an_immediate_property_by_where_clause' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_set_an_immediate_property_by_id -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L62-L82' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_set_an_immediate_property_by_id' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_initialise_a_new_property_by_expression -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L90-L100' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_initialise_a_new_property_by_expression' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_duplicate_to_new_field -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L158-L172' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_duplicate_to_new_field' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

The same value can be copied to multiple new locations:

<!-- snippet: sample_plv8_duplicate_to_multiple_new_fields -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L184-L189' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_duplicate_to_multiple_new_fields' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_increment_for_int -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L203-L222' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_increment_for_int' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

By default, the `Patch.Increment()` operation will add 1 to the existing value. You can optionally override the increment:

<!-- snippet: sample_plv8_increment_for_int_with_explicit_increment -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L224-L243' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_increment_for_int_with_explicit_increment' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_append_complex_element -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L346-L370' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_append_complex_element' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_insert_first_complex_element -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L502-L526' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_insert_first_complex_element' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_remove_primitive_element -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L618-L646' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_remove_primitive_element' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

Removing complex items can also be accomplished, matching is performed on all fields:

<!-- snippet: sample_plv8_remove_complex_element -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L686-L711' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_remove_complex_element' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

To remove reoccurring values from a collection specify `RemoveAction.RemoveAll`:

<!-- snippet: sample_plv8_remove_repeated_primitive_element -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L648-L684' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_remove_repeated_primitive_element' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_rename_deep_prop -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L594-L616' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_rename_deep_prop' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<!-- snippet: sample_plv8_delete_redundant_property -->
<a id='snippet-sample_plv8_delete_redundant_property'></a>
```cs
theSession.Patch<Target>(target.Id).Delete("String");
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L720-L722' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_delete_redundant_property' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

To delete a redundant property nested on a child class specify a location lambda:

<!-- snippet: sample_plv8_delete_redundant_nested_property -->
<a id='snippet-sample_plv8_delete_redundant_nested_property'></a>
```cs
theSession.Patch<Target>(target.Id).Delete("String", t => t.Inner);
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L740-L742' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_delete_redundant_nested_property' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

A current property may be erased simply with a lambda:

<!-- snippet: sample_plv8_delete_existing_property -->
<a id='snippet-sample_plv8_delete_existing_property'></a>
```cs
theSession.Patch<Target>(target.Id).Delete(t => t.Inner);
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L760-L762' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_delete_existing_property' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

Many documents may be patched using a where expressions:

<!-- snippet: sample_plv8_delete_property_from_many_documents -->
...
```
<sup><a href='https://github.com/JasperFx/marten/blob/master/src/Marten.PLv8.Testing/Patching/patching_api.cs#L782-L792' title='Snippet source file'>snippet source</a> | <a href='#snippet-sample_plv8_delete_property_from_many_documents' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
