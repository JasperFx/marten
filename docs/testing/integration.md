...
::: tip
For the other half of the suite — testing what a command handler *decides*, with no database at
all — see [Unit Testing Event Handlers](/testing/unit-testing-event-handlers).
:::
