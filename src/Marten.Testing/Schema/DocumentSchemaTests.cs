...
namespace Marten.Testing.Schema
{
    ...
    public class DocumentSchemaTests : IntegratedFixture
    {
        ...
        {
            var storage = theStore.Tenants.Default.StorageFor(typeof(User));
        ...
        public void can_create_storage_for_a_document_type_with_subclasses()
        {
            ...
            theStore.Tenants.Default.StorageFor(typeof(Squad)).ShouldNotBeNull();
        }
        ...
        public void can_resolve_mapping_for_subclass_type()
        {
            ...
            var mapping = theStore.Tenants.Default.MappingFor(typeof(BaseballTeam)).ShouldBeOfType<SubClassMapping>();
        ...
        public void can_resolve_document_storage_for_subclass()
        {
            ...
            theStore.Tenants.Default.StorageFor(typeof(BaseballTeam))
        ...
        public void caches_storage_for_a_document_type()
        {
            theStore.Tenants.Default.StorageFor(typeof(User))
                .ShouldBeSameAs(theStore.Tenants.Default.StorageFor(typeof(User)));

            theStore.Tenants.Default.StorageFor(typeof(Issue))
                .ShouldBeSameAs(theStore.Tenants.Default.StorageFor(typeof(Issue)));

            theStore.Tenants.Default.StorageFor(typeof(Company))
                .ShouldBeSameAs(theStore.Tenants.Default.StorageFor(typeof(Company)));
        }
        ...
        public void generate_ddl()
        {
            ...
            theStore.Tenants.Default.StorageFor(typeof(Issue));
            theStore.Tenants.Default.StorageFor(typeof(Company));
            theStore.Tenants.Default.EnsureStorageExists(typeof(IntDoc));
    ...
    public class building_id_assignment_for_document_types
    {
        ...
        {
            theStore.Tenants.Default.IdAssignmentFor<User>()
                .ShouldNotBeNull();
        }
        ...
        {
            theStore.Tenants.Default.IdAssignmentFor<IntDoc>().ShouldNotBeNull();
            theStore.Tenants.Default.IdAssignmentFor<LongDoc>().ShouldNotBeNull();
        }

        [Fact]
        public void can_build_for_a_field()
        {
            theStore.Tenants.Default.IdAssignmentFor<StringFieldGuy>()
                .ShouldNotBeNull();
        }
