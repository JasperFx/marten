...
namespace Marten.Testing.Linq
{
    public class previewing_the_command_from_a_queryable_Tests : DocumentSessionFixture<NulloIdentityMap>
    {
        ...
        public void preview_basic_select_command()
        {
            ...
            cmd.CommandText.ShouldBe("select data, id from mt_doc_target as d");
        ...
        public void preview_command_with_where_and_parameters()
        {
            ...
            cmd.CommandText.ShouldBe("select data, id from mt_doc_target as d where (CAST(d.data ->> 'Number' as integer) = :arg0) and (CAST(d.data ->> 'Double' as double precision) > :arg1)");
        ...
        public void preview_select_on_query()
        {
            ...
            cmd.CommandText.Trim().ShouldBe("select data, id from mt_doc_target as d order by CAST(d.data ->> 'Double' as double precision) LIMIT 1");
        }
    }
}