...
namespace Marten.Testing.Events.Projections.ViewProjections.SimpleWithOneToMany
{
    ...
    #endregion sample_view-projection-simple-with-one-to-many

    public class simple_multi_stream_projection_with_one_to_many: IntegrationContext
    {
        [Fact]
        ...
        public simple_multi_stream_projection_with_one_to_many(DefaultStoreFixture fixture): base(fixture)
        {
            StoreOptions(_ =>
            {
                _.DatabaseSchemaName = "simple_multi_stream_projection_with_one_to_many";
