...
{
    public class load_not_yet_persisted_document_Tests : DocumentSessionFixture
    {
        ...
        public void given_document_with_same_id_is_already_added_then_exception_should_occur()
        {
            ...
            Exception<InvalidOperationException>.ShouldBeThrownBy(() => theSession.Store(user2))
                .Message.ShouldBe("Entity 'Marten.Testing.Documents.User' with same Id already added to the session.");
        }
    }
}