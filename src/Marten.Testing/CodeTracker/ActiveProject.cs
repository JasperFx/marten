...
public class ActiveProject
{
    ...
    {
        get => _contributors.OrderBy(x => x).ToArray();
        set
        {
            _contributors.Clear();
    ...
    protected bool Equals(ActiveProject other)
    {
        return string.Equals(ProjectName, other.ProjectName) &&
               string.Equals(OrganizationName, other.OrganizationName) && LinesOfCode == other.LinesOfCode &&
               OpenIssueCount == other.OpenIssueCount && Contributors.SequenceEqual(other.Contributors);
    }
    ...
    {
        return
            $"ProjectName: {ProjectName}, OrganizationName: {OrganizationName}, LinesOfCode: {LinesOfCode}, OpenIssueCount: {OpenIssueCount}, Contributors: {Contributors}";
    }
}
