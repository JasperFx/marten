...
{
    // START: NoneFindUserByAllTheThingsCompiledQuery1745224074
    public class NoneFindUserByAllTheThingsCompiledQuery1745224074 : Marten.Internal.CompiledQueries.ClonedCompiledQuery<Marten.Testing.Documents.User, Marten.Testing.Linq.Compiled.FindUserByAllTheThings>
    {
        ...
        public NoneFindUserByAllTheThingsCompiledQuery1745224074(Marten.Linq.QueryHandlers.IMaybeStatefulHandler inner, Marten.Testing.Linq.Compiled.FindUserByAllTheThings query, Marten.Linq.QueryStatistics statistics, Marten.Internal.CompiledQueries.HardCodedParameters hardcoded) : base(inner, query, statistics, hardcoded)
        {
            _inner = inner;
            _query = query;
    ...
    // END: NoneFindUserByAllTheThingsCompiledQuery1745224074
    
    
    // START: NoneFindUserByAllTheThingsCompiledQuerySource1745224074
    public class NoneFindUserByAllTheThingsCompiledQuerySource1745224074 : Marten.Internal.CompiledQueries.CompiledQuerySource<Marten.Testing.Documents.User, Marten.Testing.Linq.Compiled.FindUserByAllTheThings>
    {
        private readonly Marten.Internal.CompiledQueries.HardCodedParameters _hardcoded;
        private readonly Marten.Linq.QueryHandlers.IMaybeStatefulHandler _maybeStatefulHandler;

        public NoneFindUserByAllTheThingsCompiledQuerySource1745224074(Marten.Internal.CompiledQueries.HardCodedParameters hardcoded, Marten.Linq.QueryHandlers.IMaybeStatefulHandler maybeStatefulHandler)
        {
            _hardcoded = hardcoded;
        ...
        {
            return new Marten.Generated.CompiledQueries.NoneFindUserByAllTheThingsCompiledQuery1745224074(_maybeStatefulHandler, query, null, _hardcoded);
        }

    }

    // END: NoneFindUserByAllTheThingsCompiledQuerySource1745224074
