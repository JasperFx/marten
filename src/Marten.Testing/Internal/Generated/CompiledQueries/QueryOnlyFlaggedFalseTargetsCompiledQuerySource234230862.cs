...
{
    // START: QueryOnlyFlaggedFalseTargetsCompiledQuery234230862
    public class QueryOnlyFlaggedFalseTargetsCompiledQuery234230862 : Marten.Internal.CompiledQueries.StatelessCompiledQuery<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.Target>, Marten.Testing.Bugs.Bug_605_unary_expressions_in_where_clause_of_compiled_query.FlaggedFalseTargets>
    {
        ...
        public QueryOnlyFlaggedFalseTargetsCompiledQuery234230862(Marten.Linq.QueryHandlers.IQueryHandler<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.Target>> inner, Marten.Testing.Bugs.Bug_605_unary_expressions_in_where_clause_of_compiled_query.FlaggedFalseTargets query, Marten.Internal.CompiledQueries.HardCodedParameters hardcoded) : base(inner, query, hardcoded)
        {
            _inner = inner;
            _query = query;
    ...
    // END: QueryOnlyFlaggedFalseTargetsCompiledQuery234230862
    
    
    // START: QueryOnlyFlaggedFalseTargetsCompiledQuerySource234230862
    public class QueryOnlyFlaggedFalseTargetsCompiledQuerySource234230862 : Marten.Internal.CompiledQueries.CompiledQuerySource<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.Target>, Marten.Testing.Bugs.Bug_605_unary_expressions_in_where_clause_of_compiled_query.FlaggedFalseTargets>
    {
        private readonly Marten.Internal.CompiledQueries.HardCodedParameters _hardcoded;
        ...
        public QueryOnlyFlaggedFalseTargetsCompiledQuerySource234230862(Marten.Internal.CompiledQueries.HardCodedParameters hardcoded, Marten.Linq.QueryHandlers.IQueryHandler<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.Target>> queryHandler)
        {
            _hardcoded = hardcoded;
        ...
        {
            return new Marten.Generated.CompiledQueries.QueryOnlyFlaggedFalseTargetsCompiledQuery234230862(_queryHandler, query, _hardcoded);
        }

    }

    // END: QueryOnlyFlaggedFalseTargetsCompiledQuerySource234230862
