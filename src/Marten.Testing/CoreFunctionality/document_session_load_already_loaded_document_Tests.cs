...
namespace Marten.Testing.CoreFunctionality
{
    ...
    public class document_session_load_already_loaded_document_Tests : IntegrationContext
    {
        [Theory]
        [SessionTypes]
        public void when_loading_then_a_different_document_should_be_returned(DocumentTracking tracking)
        {
        ...
        [Theory]
        [SessionTypes]
        public void when_loading_by_ids_then_a_different_document_should_be_returned(DocumentTracking tracking)
        {
            DocumentTracking = tracking;
