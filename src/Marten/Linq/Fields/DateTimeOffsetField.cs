...
{
    public DateTimeOffsetField(string dataLocator, string schemaName, Casing casing, MemberInfo[] members): base(
        dataLocator, "timestamp with time zone", casing, members)
    {
