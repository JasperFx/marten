...
namespace Marten.Linq.Parsing
{
    public class In: IMethodCallParser
    {
        ...
        {
            return expression.Method.Name == nameof(LinqExtensions.In)
        ...
        public IWhereFragment Parse(IQueryableDocument mapping, ISerializer serializer, MethodCallExpression expression)
        {
            ...
            {
                return new EnumInWhereFragment(values, serializer.EnumStorage, locator);
            }
    ...
    public class EnumInWhereFragment: IWhereFragment
    {
        private readonly object _values;
        private readonly string _locator;
        private readonly NpgsqlDbType _dbType;

        public EnumInWhereFragment(object values, EnumStorage enumStorage, string locator)
        {
