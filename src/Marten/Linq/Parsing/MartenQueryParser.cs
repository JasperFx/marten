...
{
    public static readonly MartenQueryParser Flyweight = new(r =>
    {
    ...
    public static readonly MartenQueryParser TransformQueryFlyweight = new(r =>
    {
        r.Register(IncludeExpressionNode.SupportedMethods, typeof(IncludeExpressionNode));
        r.Register(OrderByComparerExpressionNode.SupportedMethods, typeof(OrderByComparerExpressionNode));
        ...
        catch (NotSupportedException e)
        {
            if (e.Message.Contains("PagedList"))
            {
                throw new BadLinqExpressionException(
                    $"The {nameof(PagedListQueryableExtensions.ToPagedList)}() operators cannot be used in compiled queries. Use {nameof(QueryStatistics)} instead.");
            }
