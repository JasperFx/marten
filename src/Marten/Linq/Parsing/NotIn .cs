...
{
    public class NotIn: IMethodCallParser
    {
    ...
    public class EnumNotInWhereFragment: IWhereFragment
    {
        private readonly object _values;
        private readonly string _locator;
        private readonly NpgsqlDbType _dbType;

        public EnumNotInWhereFragment(object values, EnumStorage enumStorage, string locator)
        {
