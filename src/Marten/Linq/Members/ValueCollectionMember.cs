...
internal class ElementComparisonFilter: ISqlFragment, ICollectionAware
{
    ...
    ICollectionAwareFilter ICollectionAware.BuildFragment(ICollectionMember member, ISerializer serializer)
    {
        ...
        {
            case "=":
                return new ElementContainmentFilter(member, Value, serializer);

            case "!=":
                return new ElementContainmentFilter(member, Value, serializer) { IsNot = true };
...
internal class ElementContainmentFilter: IReversibleWhereFragment, ICollectionAwareFilter
{
    private readonly string _locator;
    private readonly ISerializer _serializer;
    private readonly Dictionary<string, object> _data;

    public ElementContainmentFilter(ICollectionMember member, object value, ISerializer serializer)
    {
        _serializer = serializer;
        _data = new Dictionary<string, object> { [member.MemberName] = new[] { value } };
