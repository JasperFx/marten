...
namespace Marten.Events.Projections.Flattened
{
    ...
    public partial class FlatTableProjection : GeneratedProjection, IProjectionSchemaSource
    {
        ...
        public FlatTableProjection(string tableName, SchemaNameSource schemaNameSource): this(new DbObjectName("public", tableName), schemaNameSource)
        {
        ...
        /// <param name="tablePrimaryKeySource">If specified, tells the projection how to find the primary key value for the table from the event data. If missing, the projection uses the event's stream identity by default</param>
