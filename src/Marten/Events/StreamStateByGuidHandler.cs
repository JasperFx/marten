...
{
    internal class StreamStateByGuidHandler : IQueryHandler<StreamState>, ISelector<StreamState>
    {
        private readonly Guid _streamId;
        private readonly EventGraph _events;

        public StreamStateByGuidHandler(EventGraph events, Guid streamId)
        {
            _streamId = streamId;
    ...
    internal class StreamStateByStringHandler : IQueryHandler<StreamState>, ISelector<StreamState>
    {
        private readonly string _streamKey;
        private readonly EventGraph _events;

        public StreamStateByStringHandler(EventGraph events, string streamKey)
        {
