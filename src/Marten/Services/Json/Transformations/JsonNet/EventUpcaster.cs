...
{
    /// <summary>
    /// <para>Base implementation of <a href="https://www.newtonsoft.com/json">Json.Net</a>
    ...
    /// <a href="https://www.newtonsoft.com/json/help/html/queryinglinqtojson.htm">Json.Net JObject</a> to <c>TEvent</c>.
        ...
        where TEvent : notnull
    {
        ...
        /// <summary>
        /// <para>Method defines the event JSON payload transformation using <a href="https://www.newtonsoft.com/json">Json.Net</a>.
    ...
    /// <a href="https://www.newtonsoft.com/json/help/html/queryinglinqtojson.htm">Json.Net JObject</a> to <c>TEvent</c>.</para>
    /// <para>Compared to the <see cref="Json.Transformations.EventUpcaster{TOldEvent,TEvent}"/> it allows to do more performant processing.
    /// <c>JObject</c>can help you to reduce the number of allocation and memory pressure.
    /// By using this implementation, you also don't need to keep the old CLR type in the codebase. Yet, implementation is a bit more tedious.</para>
        ...
        where TEvent : notnull
    {
        ...
        /// <summary>
        /// <para>Method defines the async event JSON payload transformation using <a href="https://www.newtonsoft.com/json">Json.Net</a>.
