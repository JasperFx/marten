...
{
    // START: IdentityOnlyUserByUsernameCompiledQuery661477123
    public class IdentityOnlyUserByUsernameCompiledQuery661477123 : Marten.Internal.CompiledQueries.ClonedCompiledQuery<Marten.Testing.Documents.User, DocumentDbTests.Reading.Linq.Compiled.UserByUsername>
    {
    ...
    // END: IdentityOnlyUserByUsernameCompiledQuery661477123
    
    
    // START: IdentityOnlyUserByUsernameCompiledQuerySource661477123
    public class IdentityOnlyUserByUsernameCompiledQuerySource661477123 : Marten.Internal.CompiledQueries.CompiledQuerySource<Marten.Testing.Documents.User, DocumentDbTests.Reading.Linq.Compiled.UserByUsername>
    {
        private readonly Marten.Internal.CompiledQueries.HardCodedParameters _hardcoded;
        private readonly Marten.Linq.QueryHandlers.IMaybeStatefulHandler _maybeStatefulHandler;

        public IdentityOnlyUserByUsernameCompiledQuerySource661477123(Marten.Internal.CompiledQueries.HardCodedParameters hardcoded, Marten.Linq.QueryHandlers.IMaybeStatefulHandler maybeStatefulHandler)
        {
            _hardcoded = hardcoded;
    ...
    // END: IdentityOnlyUserByUsernameCompiledQuerySource661477123
