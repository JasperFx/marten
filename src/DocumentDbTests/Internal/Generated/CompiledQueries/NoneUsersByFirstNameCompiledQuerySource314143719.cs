...
{
    // START: NoneUsersByFirstNameCompiledQuery314143719
    public class NoneUsersByFirstNameCompiledQuery314143719 : Marten.Internal.CompiledQueries.ClonedCompiledQuery<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.User>, DocumentDbTests.Reading.Linq.Compiled.UsersByFirstName>
    {
        private readonly Marten.Linq.QueryHandlers.IMaybeStatefulHandler _inner;
        private readonly DocumentDbTests.Reading.Linq.Compiled.UsersByFirstName _query;
    ...
    // END: NoneUsersByFirstNameCompiledQuery314143719
    
    
    // START: NoneUsersByFirstNameCompiledQuerySource314143719
    public class NoneUsersByFirstNameCompiledQuerySource314143719 : Marten.Internal.CompiledQueries.CompiledQuerySource<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.User>, DocumentDbTests.Reading.Linq.Compiled.UsersByFirstName>
    {
        private readonly Marten.Internal.CompiledQueries.HardCodedParameters _hardcoded;
        ...
        public override Marten.Linq.QueryHandlers.IQueryHandler<System.Collections.Generic.IEnumerable<Marten.Testing.Documents.User>> BuildHandler(DocumentDbTests.Reading.Linq.Compiled.UsersByFirstName query, Marten.Internal.IMartenSession session)
        {
            return new Marten.Generated.CompiledQueries.NoneUsersByFirstNameCompiledQuery314143719(_maybeStatefulHandler, query, null, _hardcoded);
        }

    }

    // END: NoneUsersByFirstNameCompiledQuerySource314143719
