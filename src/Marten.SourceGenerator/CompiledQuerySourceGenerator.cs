...
public sealed class CompiledQuerySourceGenerator : IIncrementalGenerator
{
        ...
        string caseBodies)
    {
        ...
        return $$"""
            // <auto-generated/>
            // Marten.SourceGenerator — #4405 PoC iteration 2.
            // Discovered compiled query: {{fullName}}
            //   Doc type:    {{docType}}
            //   Output type: {{outputType}}
            //
            // This handler class is the AOT-safe replacement for the per-query type
            // currently emitted by JasperFx.RuntimeCompiler at first use. The runtime
            // registry (#4405 iteration 3) populates the binder cache from this class
            // instead of running CompiledQuerySourceBuilder.AssembleTypes.
