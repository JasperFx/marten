...
public class WriteTableWithStringIdentifierProjection: FlatTableProjection
{
    public WriteTableWithStringIdentifierProjection() : base("string_values", SchemaNameSource.DocumentSchema)
    {
        // Gotta have a primary key
...
public class WriteTableWithEventMemberIdentityProjection: FlatTableProjection
{
    public WriteTableWithEventMemberIdentityProjection() : base("member_values", SchemaNameSource.DocumentSchema)
    {
        // Gotta have a primary key
