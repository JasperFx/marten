...
public class when_registering_an_iprojection_through_ioc_as_singleton: IAsyncLifetime
{
    private IHost _host;
    ...
    {
        source.ImplementationType.ShouldBe(typeof(LetterProjection));
    }
