...
public class when_registering_an_eventprojection_through_ioc_as_singleton: IAsyncLifetime
{
    private IHost _host;
        ...
        _host = await Host.CreateDefaultBuilder()
            .ConfigureServices(services =>
            {
                ...
                services.AddMarten(opts =>
                {
                    ...
                    opts.DatabaseSchemaName = "ioc7";


                }).AddProjectionWithServices<LetterProjection2>(ProjectionLifecycle.Inline, ServiceLifetime.Singleton,
                    x =>
                    {
                        x.Name = "Letters";
                        x.Version = 2;
