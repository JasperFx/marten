...
namespace Marten.NodaTime.Linq.Parsing
{
    ...
    public class SimpleNodaTimeEqualsParser : IMethodCallParser
    {
        private static readonly Type[] SupportedTypes = {
            typeof(LocalDate), typeof(LocalDateTime)
        };
        ...
        public SimpleNodaTimeEqualsParser(string equalsOperator = "=", string isOperator = "is", bool supportContainment = true)
        {
